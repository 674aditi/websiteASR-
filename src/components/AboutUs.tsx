  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-r from-blue-50 to-white p-10 flex flex-col">
      <div className="w-full flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="absolute top-10 left-10 w-3/4 md:w-1/4">
          <h2 className="text-red-500 text-lg font-semibold mb-2">About Us</h2>
          <h1 className="text-4xl md:text-5xl font-bold leading-tight text-gray-900 mb-4">
            You Can Imagine <br /> I Can Do
          </h1>
          <div className="w-40 md:w-80 h-1 bg-red-500 mb-6"></div>
        </div>

        {/* Right Section: Image & About Me Card */}
        <div className="relative w-full flex justify-center md:justify-end mt-20 md:mt-10 mr-0 md:mr-50">
          {/* Profile Image */}
          <img 
            src={image6} 
            alt="Profile" 
            className="w-40 md:w-150 h-auto object-cover shadow-lg"
          />

          {/* About Me Box */}
          <div className="absolute bottom-10 left-5 md:left-50 bg-white p-6 rounded-lg shadow-xl max-w-full md:max-w-lg">
